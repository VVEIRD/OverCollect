...
public class JOWSidebar extends JPanel {
	...
	public JOWSidebar(OverWatchCollectorApp app) {
		...
		setLayout(new FormLayout(
				new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"),
						FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"), FormSpecs.RELATED_GAP_COLSPEC,
						ColumnSpec.decode("30px"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"),
						FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"), FormSpecs.RELATED_GAP_COLSPEC,
						ColumnSpec.decode("30px"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"),
						FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px:grow"), FormSpecs.RELATED_GAP_COLSPEC,
						ColumnSpec.decode("30px"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"),
						FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"), FormSpecs.RELATED_GAP_COLSPEC,
						ColumnSpec.decode("30px"), FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"),
						FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("30px"), FormSpecs.RELATED_GAP_COLSPEC, },
				new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("30px"),
