...
public class FilterEngine implements ImageListener
{
	...
	/**
	 * Adds a {@link OWItemImageListener}, that will be triggered if a filter is matched
	 * @param listener
	 */
	 ...
	 * @param i		Image that matched the filter
	 * @param item	{@link OWItem} that contains the filter which matched the image.
	 */
	...
	/**
	 * Task tah will check the screenshot against the filters of the appropriate screen resolution.
	 * @author rcBlum
	 *
	 */
